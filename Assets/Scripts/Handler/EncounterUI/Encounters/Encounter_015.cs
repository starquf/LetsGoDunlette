    ...
    public override void Init()
    {
        ...
        if(scrollCount<2)
        {
            ...
            randomEncounterUIHandler.encounterChoiceTxtList[0].transform.parent.GetComponent<Button>().onClick.AddListener(() =>
            {
                ...
                textEffect.Play("Ω∫≈©∑—¿Ã 2∞≥ ¿ÃªÛ¿Ã æ∆¥’¥œ¥Ÿ.");
    ...
    public override void ResultSet(int resultIdx)
    {
        ...
        switch (resultIdx)
        {
            case 0:
                ...
                en_End_Result = "∞°¡ˆ∞Ì ¿÷¥¬ ∑£¥˝ Ω∫≈©∑— 2∞≥∏¶ ¿“∞Ì, ∑£¥˝ ¿Øπ∞ «œ≥™ »πµÊ";
                ...
                Debug.LogWarning("¿Øπ∞ πÃ±∏«ˆ");
                break;
            case 1:
                showText = en_End_TextList[0];
                showImg = en_End_Image[1];
                en_End_Result = "∑£¥˝ ∑Í∑ø ¡∂∞¢ «—∞≥∏¶ ¿“∞Ì, «ˆ¿Á µ∑¿ª 2πË∑Œ ∫“∏∞¥Ÿ.";
